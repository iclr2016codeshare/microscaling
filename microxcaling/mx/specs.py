...
class MxSpecs(collections.UserDict):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.help_strings = {
            ...
            "e8m0_scale": "[EXPERIMENTAL] Weight scaling factor for E8M0",
            "pertensor_wscale": "[EXPERIMENTAL] Enable per-tensor scaling of weights",
            "pertensor_ascale": "[EXPERIMENTAL] Enable per-tensor scaling of activations",
            "scale_min": "[EXPERIMENTAL] Lower threshold for quantized scales",
        }
